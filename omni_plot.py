"""
Ultimate Omni Plot - Maximum Infall Physics Information

This version includes EVERYTHING you could want to know about the infall physics:
- Separate infall rate curves for each episode
- Cumulative mass from each infall
- Infall mass ratio evolution
- Gas depletion timescale
- Star formation efficiency
- Outflow rates
- Mass budget pie chart
- Key physics metrics in text boxes
"""
