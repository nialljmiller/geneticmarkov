...
def weighted_quantile(values, quantiles, sample_weight):
    ...
    quantiles : array-like
        Quantile levels (e.g., [0.16, 0.50, 0.84] for 1σ)
    sample_weight : array-like
        Weights for each value (must sum to 1 or will be normalized)
...
if __name__ == '__main__':
    ...
    print(f"Weighted quantiles test: {result}")
    print("Expected: approximately [2, 3, 4]")
